        ...
        <form wire:submit="save">
            ...
            <div class="card">
                ...
                <div class="mb-4">
                    ...
                    <x-select name="category_id" class="w-full" wire:model="subcategoryEdit.category_id">
                        ...
                        @foreach ($this->categories as $category)
                            <option value="{{$category->id}}" @selected(old('categoryy_id') == $category->id)>
                                {{$category->name}}
                            </option>
                        @endforeach
                    </x-select>
                ...
                <div class="mb-4">
                    ...
                    <x-input class="w-full" placeholder="Ingrese el nombre de la subcategoria"  wire:model="subcategoryEdit.name"/>
                </div>
